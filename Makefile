black:
	black --target-version py38 bulk tests setup.py

flake:
	flake8 bulk tests setup.py
...
interrogate:
	...
	interrogate -vv --ignore-nested-functions --ignore-semiprivate --ignore-private --ignore-magic --ignore-module --ignore-init-method --fail-under 100 bulk
